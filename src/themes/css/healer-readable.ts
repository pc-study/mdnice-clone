...
.markdown-body h1 {
  font-size: 30px;
  background: linear-gradient(#fff 60%, #c6e3ff 40%);
}
...
.markdown-body h2 {
  font-size: 24px;
  background: linear-gradient(#fff 60%, #cce3fb 40%);
}
...
.markdown-body a:hover, .markdown-body a:active {
  color: #275b8c;
  border-bottom: 1px solid #275b8c;
}
.markdown-body a:hover::after, .markdown-body a:active::after {
  display: inline-block;
}
.markdown-body table {
