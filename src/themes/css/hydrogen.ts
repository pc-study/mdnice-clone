...
.markdown-body h2::first-letter,
.markdown-body h3::first-letter,
...
.markdown-body a.footnote-backref::after, .markdown-body a.footnote-ref::after {
...
.markdown-body details summary:hover::-webkit-details-marker {
  color: #1976d2;
}
