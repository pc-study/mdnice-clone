...
.markdown-body p code, .markdown-body li code {
  ...
  border-radius: 0;
  padding: 2px 5px;
  border-left: 2px solid rgb(119, 175, 156);
  color: #6E7783;
}
.markdown-body h1 {
  display: table;
...
.markdown-body h3, .markdown-body h2, .markdown-body h1 {
  background: rgba(119, 175, 156, 0.22);
  color: #6E7783;
  padding: 5px 10px;
...
.markdown-body h3:hover, .markdown-body h2:hover, .markdown-body h1:hover {
  border: 1px solid rgb(119, 175, 156);
}
.markdown-body h1 {
  font-size: 1.6em;
}
